...
func (*AnotherExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_21d110045b8a354c, []int{0}
}
...
func init() { proto.RegisterFile("proto2_ext2.proto", fileDescriptor_21d110045b8a354c) }

var fileDescriptor_21d110045b8a354c = []byte{
